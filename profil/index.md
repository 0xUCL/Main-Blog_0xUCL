...
<div class="terminal-box">
  ...
  <div class="terminal-content"><span class="prompt">oxucl@unsri:~$</span> cat focus.txt
- Capture The Flag
- Web Exploitation
- Cryptography
- Forensics
...
<div class="profile-grid">
  <div class="profile-card">
    ...
    <h3>CTF Practice</h3>
    <p>Latihan soal CTF dari berbagai kategori untuk meningkatkan kemampuan problem solving dan analisis teknis.</p>
  </div>
  <div class="profile-card">
    <i class="icon fa-solid fa-book-open"></i>
    <h3>Dokumentasi</h3>
    <p>Setiap penyelesaian ditulis ulang menjadi write-up agar bisa dipelajari anggota lain.</p>
  </div>
  <div class="profile-card">
    <i class="icon fa-solid fa-chalkboard-user"></i>
    <h3>Sharing Session</h3>
    <p>Materi, diskusi, dan pembahasan soal dilakukan untuk membangun budaya belajar bersama.</p>
  </div>
</div>